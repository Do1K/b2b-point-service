...
## 2️⃣ [성능 개선] 선착순 쿠폰 발급 시스템: 비관적 락의 한계를 넘어 비동기 아키텍처로
...
## 3️⃣ [성능 개선] 보이지 않는 병목, API 인증 인터셉터 최적화기
...
## 4️⃣ [성능 개선] 쿠폰 발급 Consumer 성능 최적화: JPA `saveAll`에서 `JdbcTemplate`으로의 전환
